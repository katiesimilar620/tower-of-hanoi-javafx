...
## Download
Grab the latest `TowerOfHanoi.jar` from the [Releases](../../releases) page and run it with:

java -jar TowerOfHanoi.jar

Requires Java 21 or newer installed. (Currently built for Windows.)
...
3. Run with the included Maven wrapper (no separate Maven install needed):
